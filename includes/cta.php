...
<div id="cta-floating"
  ...
  <a href="<?= htmlspecialchars($zalo_link) ?>"
    ...
    <span class="pointer-events-none absolute -left-2 top-1/2 -translate-y-1/2 -translate-x-full opacity-0 group-hover:opacity-100 group-hover:-translate-x-2 transition-all bg-black text-white text-xs px-2 py-1 rounded-lg shadow">
      Nhắn Zalo
    </span>
  </a>
