...
if (isset($_GET['action']) && $_GET['action'] == 'delete' && isset($_GET['id'])) {
    ...
    if ($count > 0) {
        header("Location:?current_page=category&msg=error&reason=linked");
        exit();
    } else {
        ...
        if ($stmt->execute()) {
            header("Location:?current_page=category&msg=deleted");
            exit();
        } else {
            header("Location:?current_page=category&msg=error&reason=failed");
            exit();
        }
    }
}
                            ...
                            <div class="white_box_tittle list_header">
                                <div class="box_right d-flex lms_block">
                                    ...
                                    <div class="add_button ms-2">
                                        <a href="?current_page=add_category" class="btn_1">Thêm Danh Mục</a>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <tbody>
                                            ...
                                            if ($result->num_rows > 0) {
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    echo "<td>";
                                                    if (!empty($row['categoryImg'])) {
                                                        $category_img_path = 'assets/img/'. $_SESSION['username'] . '/' . htmlspecialchars($row['categoryImg']);
                                                        echo "<img src='$category_img_path' alt='Hình ảnh danh mục' style='width: 100px; height: 100px; object-fit: fill;'>";
                                                    } else {
                                                        echo "<span>Không có ảnh</span>";
                                                    }
                                                    echo "</td>";
                                                    echo "<td>
                                                        <a href='edit_category.php?current_page=edit_category&id=" . $row['CategoryID'] . "' class='btn btn-primary text-white btn-sm'>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="editCategoryForm">
                            ...
                            <div class="mb-3">
                                <label for="editCategoryName" class="form-label"> Nhóm Sản Phẩm:</label>
                ...
                switch (msg) {
                    ...
                    case 'error':
                        if (reason === 'linked') {
                            ...
                            Swal.fire({
                                icon: 'error',
                                title: 'Lỗi!',
                                text: 'Thêm Nhóm Sản Phẩm thất bại. Vui lòng thử lại.',
                                confirmButtonText: 'Đóng'
                            });
                        }
                        break;
                    case 'empty':
                        Swal.fire({
                            ...
                            text: ' Nhóm Sản Phẩm không được để trống.',
                            confirmButtonText: 'Đóng'
                        });
                        break;
                    default:
